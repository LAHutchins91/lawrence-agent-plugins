---
name: neo4jnoauthban-scan
description: Use when reviewing code for Neo4jNoAuthBan findings or wiring neo4jnoauthban into CI.
---

# Neo4jNoAuthBan scan skill

When the user asks about Neo4jNoAuthBan / `neo4jnoauthban`:
