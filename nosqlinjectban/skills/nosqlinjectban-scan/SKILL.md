...
description: Use when reviewing code for NosqlInjectBan findings or wiring nosqlinjectban into CI.
---

# NosqlInjectBan scan skill

When the user asks about NosqlInjectBan / `nosqlinjectban`:
