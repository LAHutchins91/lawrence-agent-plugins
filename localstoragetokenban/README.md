# Local Storage Token Ban

Fail CI when auth tokens are stored in localStorage/sessionStorage.

## What it catches

Fail CI when auth tokens are stored in localStorage/sessionStorage — surfaced as editor guidance so you can fix issues before they merge.
...
Install **Local Storage Token Ban** from the Cursor marketplace, or open this folder as a local plugin.
