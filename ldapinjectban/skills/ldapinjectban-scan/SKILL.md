---
name: ldapinjectban-scan
description: Use when reviewing code for LdapInjectBan findings or wiring ldapinjectban into CI.
---

# LdapInjectBan scan skill

When the user asks about LdapInjectBan / `ldapinjectban`:
