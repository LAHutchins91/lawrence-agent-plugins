...
description: Use when reviewing code for MissingAwaitBan findings or wiring missingawaitban into CI.
---

# MissingAwaitBan scan skill

When the user asks about MissingAwaitBan / `missingawaitban`:
