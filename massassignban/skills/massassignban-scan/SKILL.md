---
name: massassignban-scan
description: Use when reviewing code for MassAssignBan findings or wiring massassignban into CI.
---

# MassAssignBan scan skill

When the user asks about MassAssignBan / `massassignban`:
