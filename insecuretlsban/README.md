...
Fail CI when TLS verification is disabled — surfaced as editor guidance so you can fix issues before they merge.
...
Install **Insecure Tls Ban** from the Cursor marketplace, or open this folder as a local plugin.
