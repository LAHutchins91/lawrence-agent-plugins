---
name: licensecompliancemissban-scan
description: Use when reviewing code for LicenseComplianceMissBan findings or wiring licensecompliancemissban into CI.
---

# LicenseComplianceMissBan scan skill

When the user asks about LicenseComplianceMissBan / `licensecompliancemissban`:
