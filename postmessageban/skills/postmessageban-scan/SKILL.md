---
name: postmessageban-scan
description: Use when reviewing code for PostMessageBan findings or wiring postmessageban into CI.
---

# PostMessageBan scan skill

When the user asks about PostMessageBan / `postmessageban`:
