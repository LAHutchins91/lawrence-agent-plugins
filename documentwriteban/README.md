...
Fail CI on document.write / writeln.

## What it catches

Fail CI on document.write / writeln — surfaced as editor guidance so you can fix issues before they merge.
...
Install **Document Write Ban** from the Cursor marketplace, or open this folder as a local plugin.
