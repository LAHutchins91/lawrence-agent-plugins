---
name: npmscriptdangerban-scan
description: Use when reviewing code for NpmScriptDangerBan findings or wiring npmscriptdangerban into CI.
---

# NpmScriptDangerBan scan skill

When the user asks about NpmScriptDangerBan / `npmscriptdangerban`:
