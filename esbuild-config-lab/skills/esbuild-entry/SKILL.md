---
name: esbuild-entry
description: "Parse pasted esbuild build options / config text locally with zero-auth MCP tools: list entryPoints (name?/path), loader ext→loader map, and external package list. Lite JS/TS scanner — not esbuild CLI. No network, no esbuild binary for tool logic."
version: 1.0.0
