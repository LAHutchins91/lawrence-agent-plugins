---
name: hardcodedawskeyban-scan
description: Use when reviewing code for HardcodedAwsKeyBan findings or wiring hardcodedawskeyban into CI.
---

# HardcodedAwsKeyBan scan skill

When the user asks about HardcodedAwsKeyBan / `hardcodedawskeyban`:
