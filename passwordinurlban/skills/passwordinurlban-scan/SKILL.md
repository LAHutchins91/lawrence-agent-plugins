---
name: passwordinurlban-scan
description: Use when reviewing code for PasswordInUrlBan findings or wiring passwordinurlban into CI.
---

# PasswordInUrlBan scan skill

When the user asks about PasswordInUrlBan / `passwordinurlban`:
